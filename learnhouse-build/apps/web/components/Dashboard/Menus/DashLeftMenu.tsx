    ...
    >
      <div className="flex flex-col h-full">
        ...
        <div className="flex grow flex-col justify-center space-y-5 items-center mx-auto">
          {/* <ToolTip content={"Назад на главную " + org?.name} slateBlack sideOffset={8} side='right'  >
          ...
          <AdminAuthorization authorizationMode="component">
            ...
            <ToolTip content={'Задания'} slateBlack sideOffset={8} side="right">
              <Link
                aria-label="Задания"
                className="bg-white/5 rounded-lg p-2 hover:bg-white/10 transition-all ease-linear"
          ...
          <div className="flex items-center flex-col space-y-2">
            ...
            <div className="flex items-center flex-col space-y-3">
              <div className="flex flex-col space-y-1 py-1">
                ...
                <ToolTip
                  content={"Настройки " + session.data.user.username}
                  slateBlack
                  sideOffset={8}
                  side="right"
                >
