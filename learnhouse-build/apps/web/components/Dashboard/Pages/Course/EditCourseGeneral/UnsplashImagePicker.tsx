...
const predefinedLabels = [
  ...
  { name: 'Мода', icon: Shirt },
  { name: 'История', icon: Book },
  { name: 'Архитектура', icon: Building },
  { name: 'Фитнес', icon: Bike },
  { name: 'Фотография', icon: Camera },
  { name: 'Биология', icon: Microscope },
  { name: 'Финансы', icon: Coins },
...
const UnsplashImagePicker: React.FC<UnsplashImagePickerProps> = ({ onSelect, onClose, isOpen = true }) => {
  ...
  return (
    <Modal
      dialogTitle="Выберите изображение из Unsplash"
