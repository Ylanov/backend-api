...
function NewActivityButton(props: NewActivityButtonProps) {
  ...
  const submitActivity = async (activity: any) => {
    ...
    const toast_loading = toast.loading('Создание активности...')
  ...
  const submitFileActivity = async (
    ...
    toast.loading('Загрузка файла и создание активности...')
  ...
  const submitExternalVideo = async (
    ...
    const toast_loading = toast.loading(
      'Создание активности и сохранение видео...'
    )
  ...
  return (
    <div className="flex justify-center">
      <Modal
        ...
        dialogTitle="Создание активности"
        dialogDescription="Выберите тип активности, которую нужно добавить в курс"
      />
      <div
        onClick={() => {
      ...
      >
        <Layers size={17} />
        <div className="text-sm font-bold ml-2">Добавить активность</div>
      </div>
    </div>
  )
}
