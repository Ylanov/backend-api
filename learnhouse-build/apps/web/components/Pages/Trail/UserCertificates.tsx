    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Мои сертификаты</h2>
        </div>
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500">Не удалось загрузить сертификаты</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-400 mt-1">Пройдите курсы, чтобы получить сертификаты</p>
        </div>
      </div>
    )
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {certificatesData.map((certificate: any) => {
          ...
          const awardedDate = new Date(
            certificate.certificate_user.created_at
