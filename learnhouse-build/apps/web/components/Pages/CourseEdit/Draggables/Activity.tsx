      ...
      {(provided) => (
        ...
        >
              ...
              <>
                <Link
                  href={
                    ...
                    `/course/${props.courseid}/activity/${props.activity.uuid.replace(
                      'activity_',
                      ''
                    )}/edit`
                  }
          ...
          <div className="flex flex-row pr-3 space-x-1 items-center">
            ...
            <ConfirmationModal
              confirmationMessage="Вы уверены, что хотите удалить эту активность?"
              confirmationButtonText="Удалить активность"
