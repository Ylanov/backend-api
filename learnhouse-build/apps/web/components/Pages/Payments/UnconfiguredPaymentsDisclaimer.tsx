      ...
      <div className="ml-10 mr-10 mx-auto">
        <Alert className="mb-3 p-6 border-2 border-yellow-200 bg-yellow-100/50 light-shadow">
          <AlertTitle className="text-lg font-semibold mb-2 flex items-center space-x-2">
            ...
            <span>Платёжная система ещё не настроена</span>
          </AlertTitle>
            ...
            <div className="pl-2">
              <ul className="list-disc list-inside space-y-1 text-gray-600 pl-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span>Настройте Stripe, чтобы принимать платежи</span>
                </li>

                <li className="flex items-center space-x-2">
                  <ShoppingCart className="h-4 w-4" />
                  <span>Создавайте и управляйте продуктами</span>
                </li>

                <li className="flex items-center space-x-2">
                  <Users className="h-4 w-4" />
                  <span>Начните продажи вашим клиентам</span>
                </li>
              </ul>
            </div>
