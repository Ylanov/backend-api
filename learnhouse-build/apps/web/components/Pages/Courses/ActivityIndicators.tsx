  ...
  <div className="bg-white rounded-lg nice-shadow py-3 px-4 min-w-[200px] animate-in fade-in duration-200">
    ...
    <div className="flex items-center gap-2 mt-2">
      ...
      <span className="text-xs text-gray-400">
        {isCurrent ? 'Текущее занятие' : isDone ? 'Завершено' : 'Не начато'}
      </span>
    </div>
  </div>
));
...
const ChapterTooltipContent = memo(({
  ...
  <div className="bg-white rounded-lg nice-shadow py-3 px-4 min-w-[200px] animate-in fade-in duration-200">
    <div className="flex items-center gap-2">
      <span className="text-sm font-medium text-gray-900">Глава {chapterNumber}</span>
      <span className="text-xs bg-gray-100 px-2 py-0.5 rounded-full text-gray-600">
        {completedActivities}/{totalActivities} завершено
      </span>
    </div>
    <div className="mt-1">
      ...
      <div className="bg-white rounded-lg nice-shadow py-3 px-4 min-w-[200px] animate-in fade-in duration-200">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-gray-900">
            {isCompleted ? 'Курс завершен!' : 'Завершение курса'}
          </span>
        </div>
        <div className="mt-1">
          <span className="text-sm text-gray-700">
            {isCompleted
              ? 'Посмотреть сертификат о завершении'
              : 'Выполните все задания, чтобы разблокировать сертификат'
            }
          </span>
        </div>
      </div>
