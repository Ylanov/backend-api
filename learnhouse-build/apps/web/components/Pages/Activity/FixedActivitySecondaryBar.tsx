...
const NavigationButtons = memo(({ 
  ...
  <div className="flex items-center space-x-2 sm:space-x-3">
    <button
      ...
      title={prevActivity ? `Предыдущая: ${prevActivity.name}` : 'Нет предыдущей активности'}
    >
      ...
      <div className="flex flex-col items-start hidden sm:flex">
        ...
        <span className="text-sm font-medium text-left truncate max-w-[100px] sm:max-w-[150px]">
          {prevActivity ? prevActivity.name : 'Нет предыдущей активности'}
        </span>
      </div>
    </button>
    ...
    <button
      ...
      title={nextActivity ? `Следующая: ${nextActivity.name}` : 'Нет следующей активности'}
    >
      <div className="flex flex-col items-end hidden sm:flex">
        ...
        <span className="text-sm font-medium text-right truncate max-w-[100px] sm:max-w-[150px]">
          {nextActivity ? nextActivity.name : 'Нет следующей активности'}
        </span>
      </div>
