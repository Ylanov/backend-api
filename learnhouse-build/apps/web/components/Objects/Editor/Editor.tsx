    ...
    return (
      <div className="h-screen w-full bg-[#f8f8f8] flex items-center justify-center p-4">
        <div className="bg-white p-6 rounded-lg shadow-md text-center">
          <h2 className="text-xl font-bold mb-4">Только для компьютеров</h2>
          <Monitor className='mx-auto my-5' size={60} />
          <p>Редактор доступен только на настольных устройствах.</p>
          <p>Пожалуйста, переключитесь на компьютер для просмотра.</p>
        </div>
      </div>
    )
  }
                ...
                <div className="transition-all ease-linear text-teal-100 rounded-md hover:cursor-pointer">
                  {isButtonAvailable && (
                    ...
                    >
                      ...
                      <i className="not-italic text-xs font-bold">AI Редактор</i>
                    </div>
                  )}
                </div>
              </div>
