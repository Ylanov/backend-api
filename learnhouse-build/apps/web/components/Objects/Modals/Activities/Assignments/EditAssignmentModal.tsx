        ...
        <FormLayout onSubmit={formik.handleSubmit}>
            <FormField name="title">
                <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                    ...
                    <FormMessage match="valueMissing">
                        Пожалуйста, укажите название задания
                    </FormMessage>
                </Flex>
            ...
            <FormField name="description">
                <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                    ...
                    <FormMessage match="valueMissing">
                        Пожалуйста, укажите описание задания
                    </FormMessage>
                </Flex>
                <Form.Control asChild>
                    <Textarea
            ...
            <FormField name="due_date">
                <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                    ...
                    <FormMessage match="valueMissing">
                        Пожалуйста, укажите срок выполнения задания
                    </FormMessage>
                </Flex>
                <Form.Control asChild>
                    <Input
            ...
            <FormField name="grading_type">
                <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                    <FormLabel>Тип оценивания</FormLabel>
                    <FormMessage match="valueMissing">
                        Пожалуйста, укажите тип оценивания для задания
                    </FormMessage>
                </Flex>
                <select
                    id="grading_type"
                    ...
                    required
                >
                    <option value="ALPHABET">Буквенная система</option>
                    <option value="NUMERIC">Числовая система</option>
                    <option value="PERCENTAGE">Процентная система</option>
                </select>
            </FormField>
            ...
            <div className="flex justify-end space-x-3 mt-6">
                ...
                <Form.Submit asChild>
                    ...
                    >
                        {formik.isSubmitting ? 'Сохранение...' : 'Сохранить изменения'}
                    </button>
                </Form.Submit>
            </div>
        </FormLayout>
...
const EditAssignmentModal: React.FC<EditAssignmentModalProps> = ({
    ...
    return (
        <Modal
            ...
            dialogTitle="Редактирование задания"
            dialogDescription="Обновите параметры задания"
            dialogTrigger={null}
        />
    );
};
