    ...
    <FormLayout onSubmit={handleSubmit}>
      <FormField name="documentpdf-activity-name">
        <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
          <FormLabel>Название PDF-документа</FormLabel>
          <FormMessage match="valueMissing">
            Пожалуйста, укажите название активности с PDF-документом
          </FormMessage>
        </Flex>
      ...
      <FormField name="documentpdf-activity-file">
        <Flex css={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
          <FormLabel>Файл PDF-документа</FormLabel>
          <FormMessage match="valueMissing">
            Пожалуйста, прикрепите PDF-документ для этой активности
          </FormMessage>
        </Flex>
        <Form.Control asChild>
