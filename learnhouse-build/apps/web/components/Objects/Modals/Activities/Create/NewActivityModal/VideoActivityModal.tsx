...
function VideoModal({
  ...
  const VideoSettingsForm = () => {
    ...
    return (
      <div className="space-y-4 mt-4 p-4 bg-gray-50 rounded-lg">
        <h3 className="font-medium text-gray-900 mb-3">Настройки видео</h3>
            ...
            <div className="flex gap-2 mt-1">
              <div className="flex-1">
                <Input
                  ...
                  className="w-full"
                />
                <span className="text-xs text-gray-500 mt-1 block">Минуты</span>
              </div>
              <div className="flex-1">
                <Input
                  type="number"
                  ...
                  className="w-full"
                />
                <span className="text-xs text-gray-500 mt-1 block">Секунды</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-6 mt-4">
          ...
          <label className="flex items-center space-x-2">
            <input
              ...
              className="rounded border-gray-300 text-black focus:ring-black"
            />
            <span className="text-sm text-gray-700">Запуск без звука</span>
          </label>
        </div>
      </div>
    );
  ...
  return (
    <Form.Root onSubmit={handleSubmit}>
      <div>
        <Label htmlFor="video-activity-name">Название активности</Label>
        <Input
        ...
        <div className="p-6">
          {selectedView === 'file' && (
            <div className="space-y-4">
              <div>
                <Label htmlFor="video-activity-file">Файл видео</Label>
                <div className="mt-2">
                  <input
