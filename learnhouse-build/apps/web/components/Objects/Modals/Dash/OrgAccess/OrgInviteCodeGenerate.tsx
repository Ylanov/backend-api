        ...
        <div className='flex space-x-2 pt-2'>
            <div className='flex bg-slate-100 w-full h-[140px] rounded-lg'>
                <div className='flex flex-col mx-auto'>
                    <h1 className='mx-auto pt-4 text-gray-600 font-medium'>Пригласительный код, привязанный к UserGroup</h1>
                    <h2 className='mx-auto text-xs text-gray-600 font-medium'>При регистрации пользователи будут автоматически добавлены в выбранную вами UserGroup</h2>
                    <div className='flex items-center space-x-4 pt-3 mx-auto'>
                        ...
                        {usergroups?.length == 0 &&
                            <div className='flex space-x-3 items-center text-xs pt-3'>
                                <span className='px-3 text-yellow-700 font-bold rounded-full py-1 mx-3'>Нет доступных UserGroup </span>
                                <Link className='px-3 text-blue-700 font-bold rounded-full py-1 bg-blue-100 mx-1' target='_blank' href={getUriWithOrg(org.slug, '/dash/users/settings/usergroups')}>Создать UserGroup </Link>
                            </div>}
                    </div>
                </div>
            </div>
            <div className='flex bg-slate-100 w-full h-[140px] rounded-lg'>
                <div className='flex flex-col mx-auto'>
                    <h1 className='mx-auto pt-4 text-gray-600 font-medium'>Обычный пригласительный код</h1>
                    <h2 className='mx-auto text-xs text-gray-600 font-medium'>При регистрации пользователь не будет привязан ни к одной UserGroup</h2>
