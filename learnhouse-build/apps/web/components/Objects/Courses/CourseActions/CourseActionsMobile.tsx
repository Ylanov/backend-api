        ...
        {authors.length === 1 ? (
          ...
          <span className="text-sm font-semibold text-neutral-800">
            {authors[0].user.first_name && authors[0].user.last_name
              ? `${authors[0].user.first_name} ${authors[0].user.last_name}`
              : `@${authors[0].user.username}`}
            {authors.length > 1 && ` и еще ${authors.length - 1}`}
          </span>
        )}
      </div>
    </div>
            ...
            {hasAccess ? (
              <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-green-800 text-sm font-semibold">Вам доступен этот курс</span>
                </div>
              </div>
            ) : (
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-amber-800 text-sm font-semibold">Платный курс</span>
                </div>
              </div>
            )}
