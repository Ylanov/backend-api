          ...
          <div className='flex gap-2 items-center'>
            ...
            <div className='flex gap-2 items-center'>
              <div className='flex gap-1 md:space-x-2 text-xs items-center text-slate-400'>
                <Calendar size={14} />
                <p className='font-semibold'>Срок сдачи</p>
        ...
        <div className='flex flex-col space-y-2 p-4 md:p-6 bg-slate-100/30 rounded-md nice-shadow'>
          <div className='flex flex-col space-y-3'>
            <div className='flex items-center gap-2 text-slate-700'>
              ...
              <h3 className='text-sm font-semibold'>Описание задания</h3>
            </div>
            <div className='pl-6'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between py-2 space-y-2 md:space-y-0'>
              ...
              <div className='flex flex-wrap gap-2'>
                <div
                  ...
                  <Info size={13} />
                  <p className='text-xs font-semibold'>Подсказка</p>
                </div>
                <Link
                  ...
                  <div className='flex items-center space-x-1 md:space-x-2'>
                    ...
                    <p className='text-xs font-semibold'>Справочный материал</p>
                  </div>
                </Link>
              </div>
            </div>
