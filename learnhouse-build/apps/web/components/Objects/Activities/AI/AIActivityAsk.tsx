      ...
      {isButtonAvailable && (
        <div>
          ...
          >
            ...
            <i className="not-italic text-xs font-bold">Спросить ИИ</i>
          </div>
        </div>
      )}
    </>
              ...
              <div className="flex space-x-2 items-center">
                ...
                <div className="w-full">
                  <input
                    ...
                    placeholder="Спросите ИИ об этом занятии"
                    type="text"
        ...
        <div className="flex flex-col text-center justify-center pt-12">
          ...
          >
            ...
            <p className="pt-3 text-2xl font-semibold text-white/70 flex justify-center space-x-2 items-center">
              <span className="items-center">Привет,</span>
...
const AIChatPredefinedQuestion = (props: {
  ...
  function getQuestion(label: string) {
    if (label === 'about') {
      return `О чем это занятие?`
    } else if (label === 'flashcards') {
      return `Создай карточки по этому занятию`
    } else if (label === 'examples') {
      return `Объясни это занятие на практических примерах`
    }
  }
  ...
  return (
    ...
    >
      ...
      {props.label === 'examples' && <div className="text-white/50">Пр</div>}
