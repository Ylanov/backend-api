      ...
      <GeneralWrapperStyled>
        ...
        <div className="flex flex-col space-y-4 mb-8">
          <div className="flex items-center justify-between">
            <TypeOfContentTitle title="Коллекции" type="col" />
                ...
                <div className="text-center">
                  ...
                  <p className="text-md text-gray-400">
                    <ContentPlaceHolderIfUserIsNotAdmin
                      text="Создайте коллекции, чтобы группировать курсы"
                    />
                  </p>
                </div>
              </div>
        ...
        <div className="flex flex-col space-y-4">
          <div className="flex items-center justify-between">
            <TypeOfContentTitle title="Курсы" type="cou" />
            <AuthenticatedClientElement
            ...
            {courses.length === 0 && (
              <div className="col-span-full flex justify-center items-center py-8">
                <div className="text-center">
                  ...
                  <p className="text-md text-gray-400">
                    <ContentPlaceHolderIfUserIsNotAdmin text="Создайте курсы, чтобы добавить контент" />
                  </p>
                </div>
              </div>
            )}
