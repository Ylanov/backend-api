...
Revision ID: 6969d667ca72
Revises: 661428aa3a33
Create Date: 2025-11-22 13:18:41.356953
...
import pgvector  # <--- ДОБАВЛЕН ИМПОРТ

# revision identifiers, used by Alembic.
revision: str = '6969d667ca72'
down_revision: Union[str, Sequence[str], None] = '661428aa3a33'
...
def upgrade() -> None:
    """Upgrade schema."""
    # --- ВРУЧНУЮ ДОБАВЛЕНА КОМАНДА ВКЛЮЧЕНИЯ РАСШИРЕНИЯ ---
    ...
    sa.Column('search_vector', postgresql.TSVECTOR(), sa.Computed("to_tsvector('russian', content)", persisted=True), nullable=True),
