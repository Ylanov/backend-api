...
// Безопасная и простая проверка e-mail:
// - нет вложенных квантификаторов и «жадных» подшаблонов с неоднозначностью,
//   поэтому нет риска катастрофического бэктрекинга;
// - дополнительно ограничиваем максимальную длину, чтобы исключить ReDoS
//   даже при попытке отправить очень длинную строку.
